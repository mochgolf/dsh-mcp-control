...
| Tool | Input | Result |
|---|---|---|
| `session_start` | `cwd`, `prompt`; optional `agent_preset`, `session_id`, `request_id` | `session_id`, `request_id`, `accepted` |
